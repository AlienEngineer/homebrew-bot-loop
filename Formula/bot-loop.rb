class BotLoop < Formula
  ...
  url "https://github.com/AlienEngineer/bot-loop/releases/download/v0.1.15/bot-loop-macos.tar.gz"
  sha256 "0ad6781d260dd83f98eaf466c8d2f1def87b12ab0d2b0e2a36f29bbebf4b009f"
  version "0.1.15"
