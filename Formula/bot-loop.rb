class BotLoop < Formula
  ...
  url "https://github.com/AlienEngineer/bot-loop/releases/download/v0.1.2/bot-loop-macos.tar.gz"
  sha256 "ef82d6c4f3a5f75ce2deb3abc95091f5e80b8b57185ca8e7e9037e76282146b5"
  version "0.1.2"
